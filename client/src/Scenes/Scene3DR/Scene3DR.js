 ...
 */
const Scene3DR = ({ speed, quantumNumbers, setIncludeM, reload }) => {
  ...
  useEffect(() => {
    ...
    helperMethods.fetchAndParseTrajectory(
      `/trajectory_data/3d/rel/${quantumNumbers.n}_${quantumNumbers.k}_${quantumNumbers.m}.csv`,
      setIsLoading,
      setError,
      setTrajectoryData,
      ["r", "phi", "theta", "delta_psi"] // Columns to parse from the CSV.
    );
  }, [reload]);
